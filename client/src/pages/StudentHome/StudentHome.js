...
import {Row, Col, Well, Media, MediaBody, MediaHeading, ListGroup, Glyphicon} from 'react-bootstrap';
    ...
    render() {
        return (
            <div>
                ...
                <Col xs={12} md={8}>
                    <Well bsSize="large">
                    <Media className="pull-left"><img className="media-object" src="http://via.placeholder.com/150x150"/></Media>
                        <h1>History 101</h1>
                        ...
                        <Glyphicon glyph="star"/> <Glyphicon glyph="star"/> <Glyphicon glyph="star"/> <Glyphicon glyph="star"/>
                        </span>
                    </Well>
                </Col>
                </Row>
