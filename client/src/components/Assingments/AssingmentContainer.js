...
//So the state is supose to update based upon the fetch from the json file 
//but that has yet to work.  SO i put the full json in the this.state.quiz and that
//atleast displays the questions and number of, and you can scroll through
//it on the site, but that's about it.  Can't figure out hwo to get the
//answers to display.  if you want to try fetching the json, comment out what is
//in the this.state.quiz object.  Yes i used a tutorial lol.  One other component
//used in Question.js for this.
...
//So I habe tried this a few ways, haven't gotten it to work
// componentDidMount() {
    //     fetch('./test.json')
    //         .then(results => {
    //             console.log(results);
